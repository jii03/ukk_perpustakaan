                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <a href="?page=ubah_peminjaman&&id=<?php echo $data['id_peminjam'] ?>" class="btn btn-info">Edit</a>
                                <a onclick="return confirm('Yakin di Hapus nih? ');" href="?page=hapus_peminjaman&&id=<?php echo $data['id_peminjam'] ?>" class="btn btn-danger">Delete</a>
                                    <?php
                                    }
                                    ?>
                            </td>
