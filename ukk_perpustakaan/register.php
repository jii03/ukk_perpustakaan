                                        ...
                                        <form method="post">
                                            <?php
                                                if(isset($_POST['register'])){
                                                   ...
                                                   $insert = mysqli_query($koneksi, "INSERT INTO user(username,password,email,nama_lengkap,alamat,no_telepon,level) VALUES ('$username', '$password', '$email', '$nama', '$alamat', '$no_telepon', '$level')");
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="inputNama" type="text" required name="nama_lengkap" placeholder="Masukkan Nama lengkap" />
                                            ...
                                            <div class="form-group">
                                                <label class="samll mb-1">No. Telepon</label>
                                                <input class="form-control" id="inputTelepon" type="text" required name="no_telepon" placeholder="Masukkan No.telp   " />
